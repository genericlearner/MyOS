...
#define MYOS_PROGRAM_VIRTUAL_STACK_SIZE 1024 * 16
#define MYOS_PROGRAM_VIRTUAL_STACK_ADDRESS_END MYOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START - MYOS_PROGRAM_VIRTUAL_STACK_SIZE

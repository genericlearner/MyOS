...
int heap_create(struct heap* heap, void* ptr, void* end, struct heap_table* table)
{
    ...
    memoryset(table->entries, HEAP_BLOCK_TABLE_ENTRY_FREE, table_size);
...
{
    return heap->startadd+(block*MYOS_HEAP_BLOCK_SIZE);
}
...
int heap_address_to_blocks(struct heap* heap, void* address)
{
    return ((int)(address-heap->startadd))/MYOS_HEAP_BLOCK_SIZE;
}
